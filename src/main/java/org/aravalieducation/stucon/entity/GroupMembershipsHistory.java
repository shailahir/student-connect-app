...
@Entity
@Table(name = "group_memberships_history", schema = "app")
@NamedQuery(name = "GroupMembershipsHistory.findAll", query = "SELECT g FROM GroupMembershipsHistory g")
public class GroupMembershipsHistory implements Serializable {
    ...
    public GroupMembershipsHistory() {
    }
